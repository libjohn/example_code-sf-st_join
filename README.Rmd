...
- `sf::st_join` with predicate functions such as `st_within` and `st_contains`
- `mapview::mapview`

### Notes

- [Notes on EPSG codes and projections](https://guides.library.duke.edu/r-geospatial/CRS#s-lib-ctab-21326020-2
)
...
See more details in the 01_explore_st_join.[Rmd|html]